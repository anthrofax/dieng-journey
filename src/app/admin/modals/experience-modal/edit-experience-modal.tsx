...
const EditExperienceModal = ({
  ...
  const { data: selectedExperience, isLoading } = useQuery({
  ...
  const { mutateAsync, isPending: isPendingMutation } = useMutation({
    mutationFn: ({ experienceId, body }: { experienceId: string; body: any }) =>
      updateExperience({
        experienceId,
        body,
      }),
  ...
  useEffect(() => {
    ...
    reset({
      experienceName: selectedExperience?.experienceName,
      description: selectedExperience?.description,
      price: selectedExperience?.price.toString(),
      destinationId: selectedExperience?.destinationId,
    });
  }, [
    selectedExperience?.experienceName,
    selectedExperience?.description,
    selectedExperience?.price,
    selectedExperience?.destinationId,
  ]);
